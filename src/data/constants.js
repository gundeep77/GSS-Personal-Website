...
export const projects = [
  ...
  },
  {
    ...
    date: "Jan 2021",
    description:
      "Created a quick task lister using React that doesn't use any database but utilizes the browser's local storage to store the tasks. Users can also categorize the tasks and filter them to easily look up.",
