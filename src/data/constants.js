export const Bio = {
  ...
  insta: "https://www.instagram.com/gundeep_77",
  facebook: "https://www.facebook.com/gundeep77",
};
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Google Colab",
        image:
          "https://repository-images.githubusercontent.com/228673061/b2c25180-3bff-11ea-965f-4b34f4c6be08",
      },
      {
        name: "Scikit-Learn",
        image:
...
export const educations = [
  {
    ...
    desc: (
      <p>
        I completed my master's degree with a major in Computer Science keeping
        my primary focus on Web Development using MERN stack. In addition to
        that, I also had the opportunity to equip myself with the most common
        Machine Learning and Deep Learning algorithms, Web Mining techniques,
        Data Structures and Algorithms in Java, and Database Management Systems.
        <br />
        <br />
        Achievements: Provost Master Scholarship <br />
        Positions: Graduate Teaching Assistant
      </p>
    ),
  },
  {
...
export const projects = [
  ...
  },
  {
    ...
    date: "Jan 2021",
    description:
      "Created a quick task lister application using React that doesn't use any database but utilizes the browser's local storage to store the tasks. Users can also categorize the tasks and filter them to easily look up.",
